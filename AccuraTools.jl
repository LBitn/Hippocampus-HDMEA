...
export VariablesBRW4, Get_Chunks, div_ab, searchdir, VoltegeConversionMeanΔxCI, StaticThresholdEvents,
       Thresholding, ThresholdingPlots, Z0, ZW, Zplot, STExbin, STExChannel, FiltMUAremez, FilteringMatrix,
       ms2frames, ΔV, VoltegeConversion, PositiveSaturation, donoho, FillingHolesCrux, Get_Groups, neighborgs,
       FigureGroups, Cut_Spikes
...
# •·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·• #
"""
    VoltegeConversion( data::Matrix{UInt16}, Variables::Dict{Any, Any} ) -> BIN::Matrix{Float64}
    Transforms the Raw dataset from the brw file into μV following the instructions from the 3Brain
    documentation for the previous brw versions.
    BitDepth variable is nowhere to be found in the metadata from the brw v4 file, so we use the parameter from
    the v3.
"""
...
function PositiveSaturation( data::Matrix{Float64}, Variables::Dict{Any, Any} )
    MaxAnalogValue = Float64( Variables[ "MaxAnalogValue" ] - 10 );
    SamplingRate = Variables[ "SamplingRate" ];
    binsize = size( data, 2 );
    MaxVoltSatChannels = findall( vec( sum( Int.( data .>= MaxAnalogValue ), dims = 2 ) .!= 0 ) )
    MaxVoltFrames = [ ];
    for k = 1:length( MaxVoltSatChannels )
        push!( MaxVoltFrames, findall( data[ MaxVoltSatChannels[ k ], : ] .>= MaxAnalogValue ) );
    end
    ...
    if length( DiscartedChannels ) == 1
        earth = DiscartedChannels[ 1 ];
    else
        println( "There is something fishy here, I can't find the reference channel" );
    end
    return DiscartedChannels, earth, data
end
# •·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·•·•·•·••·•·•·•·•·•·• #
"""
